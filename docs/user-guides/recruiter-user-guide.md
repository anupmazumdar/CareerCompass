...
4. **Inspect Match Explanations**: Review candidate skills alignment, project relevance, and experience.
5. **Manage Candidates**: Move candidates across stages: `APPLIED` -> `SHORTLISTED` -> `INTERVIEW` -> `OFFER`.
